...
This guide covers the six advanced deployment methods available in AgentScope Runtime, providing production-ready solutions for different scenarios: **Local Daemon**, **Detached Process**, **Kubernetes Deployment**, **ModelStudio Deployment**, **AgentRun Deployment**, and **FC (Function Compute) Deployment**.
...
| **FC** | Alibaba Cloud Serverless | Cloud-managed | Platform-managed | Container-level |
...
## Method 6: Serverless Deployment: FC (Function Compute)
