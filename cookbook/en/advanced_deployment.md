...
| **Sandbox**               | Enterprise & Cloud | Single-node | Orchestrated | Container-level / MicroVM-level |
...
**Key Points**:
- Isolated deployment based on Sandbox CRD, each agent runs in an independent environment
