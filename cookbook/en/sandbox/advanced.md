...
| Typical startup time | < 100 ms                  | < 200 ms                             | < 1 s                                       | Seconds (scheduling/pull dependent)                      | Seconds (cold start dependent)           | Seconds (cold start dependent)           | Seconds (scheduling/pull dependent)                      | < 125 ms                             |
...
| OS support           | Linux/macOS/Windows       | Linux/macOS                          | macOS (Apple Silicon), Linux (x86_64/ARM64) | Linux (cluster nodes)                                    | Managed (cloud)                          | Managed (cloud)                          | Managed (cloud)                                          | Linux (x86_64/ARM64)                 |
