...
- **多类型支持**：支持不同类型的沙箱（`BASE`、`BROWSER`、`CODE`、`AGENTBAY`、`CLOUD_COMPUTER`、`CLOUD_PHONE`、`E2B` 等）。
...
| `CLOUD_COMPUTER` | 无影云电脑沙箱          | 专用于多Agent协作或复杂任务编排的持久环境 |
| `CLOUD_PHONE`    | 无影云手机沙箱          | 专用于多Agent协作或复杂任务编排的持久环境 |
| `E2B`            | E2B沙箱            | 专用于多Agent协作或复杂任务编排的持久环境 |
